...
const Cart = () => {
    ...
    const fetchCart = async () => {
      try {
        const res = await axios.get(
          `https://new-ecom-roj3vse20-abhishek-k-s-s-projects.vercel.app/user/cart/${userId}`
        );
  ...
  const handleRemove = async (productId) => {
    try {
      await axios.delete("https://new-ecom-roj3vse20-abhishek-k-s-s-projects.vercel.app/user/cart/remove", {
      ...
      {cartItems.length === 0 ? (
        ...
        <>
          ...
          <Button
            ...
            onClick={async () => {
              try {
                await axios.delete(`https://new-ecom-roj3vse20-abhishek-k-s-s-projects.vercel.app/user/cart/clear`, {
                  data: { userId },
                });
                setCartItems([]);
                alert(
